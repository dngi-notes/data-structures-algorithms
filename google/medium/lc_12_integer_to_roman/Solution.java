package google.medium.lc_12_integer_to_roman;
...
public class Solution {
   ...
   public String intToRoman(int x) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s.intToRoman(3749)); // expected: MMMDCCXLIX
        System.out.println(s.intToRoman(58)); // expected: LVIII
        System.out.println(s.intToRoman(1994)); // expected: MCMXCIV
    }
}
